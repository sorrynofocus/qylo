Name: clang LLVM compiler
Description: CLi for clang 
...
OPTIONS:
  ...
  -clangir-enable-idiom-recognizer
                          ClangIR: Enable Idiom Recognizer pass
  -clangir-lib-opt=<value>
                          Enable C/C++ library based optimizations (with options)
  -clangir-lib-opt        Enable C/C++ library based optimizations
  --config=<file>         Specify configuration file
  --cstdlib=<value>       C standard library to use
  ...
  -fconstant-nsarray-literals
                          Enable compile-time constant NSArray literals
  -fconstant-nsdictionary-literals
                          Enable compile-time constant NSDictionary literals
  -fconstant-nsnumber-literals
                          Enable compile-time constant NSNumber literals
  ...
  -fcrash-diagnostics-tar=<path>
                          Put crash-report tarball at <path>
  ...
  -fdebug-record-sysroot  Record the sysroot path in debug info as DW_AT_LLVM_sysroot and in DW_AT_LLVM_include_path (used by LLDB to locate the SDK for Clang module imports).
  ...
  -fenable-new-pm-codegen Use the NewPM for the Codegen Pipeline
  ...
  -fexperimental-allow-pointer-field-protection-attr
                          Allow the use of the [[clang::pointer_field_protection]] attribute
  ...
  -fexperimental-pointer-field-protection-abi
                          Enable pointer field protection on all non-standard layout struct types
  ...
  -ffixed-edi             Reserve the edi register (x86 only)
  ...
  -ffixed-r10             Reserve the r10 register (Hexagon/x86_64 only)
  -ffixed-r11             Reserve the r11 register (Hexagon/x86_64 only)
  -ffixed-r12             Reserve the r12 register (Hexagon/x86_64 only)
  -ffixed-r13             Reserve the r13 register (Hexagon/x86_64 only)
  -ffixed-r14             Reserve the r14 register (Hexagon/x86_64 only)
  -ffixed-r15             Reserve the r15 register (Hexagon/x86_64 only)
  -ffixed-r16             Reserve the r16 register (Hexagon/x86_64 only; x86_64 requires APX EGPR)
  -ffixed-r17             Reserve the r17 register (Hexagon/x86_64 only; x86_64 requires APX EGPR)
  -ffixed-r18             Reserve the r18 register (Hexagon/x86_64 only; x86_64 requires APX EGPR)
  -ffixed-r19             Reserve register r19 (Hexagon/x86_64 only; x86_64 requires APX EGPR)
  -ffixed-r20             Reserve the r20 register (Hexagon/x86_64 only; x86_64 requires APX EGPR)
  -ffixed-r21             Reserve the r21 register (Hexagon/x86_64 only; x86_64 requires APX EGPR)
  -ffixed-r22             Reserve the r22 register (Hexagon/x86_64 only; x86_64 requires APX EGPR)
  -ffixed-r23             Reserve the r23 register (Hexagon/x86_64 only; x86_64 requires APX EGPR)
  -ffixed-r24             Reserve the r24 register (Hexagon/x86_64 only; x86_64 requires APX EGPR)
  -ffixed-r25             Reserve the r25 register (Hexagon/x86_64 only; x86_64 requires APX EGPR)
  -ffixed-r26             Reserve the r26 register (Hexagon/x86_64 only; x86_64 requires APX EGPR)
  -ffixed-r27             Reserve the r27 register (Hexagon/x86_64 only; x86_64 requires APX EGPR)
  -ffixed-r28             Reserve the r28 register (Hexagon/x86_64 only; x86_64 requires APX EGPR)
  -ffixed-r29             Reserve the r29 register (Hexagon/x86_64 only; x86_64 requires APX EGPR)
  -ffixed-r30             Reserve the r30 register (Hexagon/x86_64 only; x86_64 requires APX EGPR)
  -ffixed-r31             Reserve the r31 register (Hexagon/x86_64 only; x86_64 requires APX EGPR)
  -ffixed-r6              Reserve register r6 (Hexagon only)
  -ffixed-r7              Reserve register r7 (Hexagon only)
  -ffixed-r8              Reserve the r8 register (Hexagon/x86_64 only)
  -ffixed-r9              Reserve the r9 register (ARM/Hexagon/x86_64 only)
  ...
  -ffixed-x16             Reserve the x16 register (RISC-V only)
  -ffixed-x17             Reserve the x17 register (RISC-V only)
  -ffixed-x18             Reserve the x18 register (AArch64/RISC-V only)
  -ffixed-x19             Reserve the x19 register (RISC-V only)
  ...
  -ffixed-x29             Reserve the x29 register (RISC-V only)
  -ffixed-x2              Reserve the x2 register (AArch64/RISC-V only)
  -ffixed-x30             Reserve the x30 register (RISC-V only)
  -ffixed-x31             Reserve the x31 register (RISC-V only)
  ...
  -ffixed-x8              Reserve the x8 register (RISC-V only)
  ...
  -fimplicit-modules-lock-timeout=<seconds>
                          Time to wait on an implicit module lock before timing out
  ...
  -flifetime-dse          Aggressively delete stores after the end of an object's lifetime
  ...
  -fms-anonymous-structs  Enable Microsoft anonymous struct/union extension.
  ...
  -fno-constant-nsarray-literals
                          Disable compile-time constant NSArray literals
  -fno-constant-nsdictionary-literals
                          Disable compile-time constant NSDictionary literals
  -fno-constant-nsnumber-literals
                          Disable compile-time constant NSNumber literals
  ...
  -fno-enable-new-pm-codegen
                          Do not use the NewPM for the Codegen Pipeline
  -fno-exceptions         Disable support for exception handling
  -fno-experimental-allow-pointer-field-protection-attr
                          Disallow the use of the [[clang::pointer_field_protection]] attribute
  ...
  -fno-experimental-pointer-field-protection-abi
                          Do not enable pointer field protection on all non-standard layout struct types
  -fno-experimental-pointer-field-protection-tagged
                          Do not use pointer identity (tag) to discriminate pointers of non-trivially-copyable types
  ...
  -fno-lifetime-dse       Do not aggressively delete stores after the end of an object's lifetime
  -fno-loop-interchange   Disable the loop interchange pass
  -fno-lto                Disable LTO mode (default)
  -fno-memory-profile     Disable heap memory profiling
  -fno-merge-all-constants
                          Disallow merging of constants
  -fno-modules-driver     Disable support for driver managed module builds (experimental)
  ...
  -fno-objc-constant-literals
                          Disable compile-time constant ObjC literals
  ...
  -fno-partition-static-data-sections
                          Disable partition static data sections using PGO profile information and MemProf (x86 and aarch64 ELF). See LLVM MemProf doc for usage.
  ...
  -fno-sanitize-trap-loop Do not use infinite loops in trapping mode
  ...
  -fno-strict-bool=<value>
                          Disable optimizations based on bool bit patterns never being anything other than 0 or 1, specifying a conversion behavior.
  -fno-strict-bool        Disable optimizations based on bool bit patterns never being anything other than 0 or 1
  ...
  -fobjc-constant-literals
                          Enable compile-time constant ObjC literals
  ...
  -fpartition-static-data-sections
                          Enable partition static data sections using PGO profile information and MemProf (x86 and aarch64 ELF). See LLVM MemProf doc for usage.
  ...
  -fpreferred-function-alignment=<value>
                          preferred alignment for functions
  ...
  -freflection            Enable C++26 reflection
  ...
  -fsanitize-ignore-for-ubsan-feature=<check>
                          Prevents `__has_feature(undefined_behavior_sanitizer)` from evaluating true for these UBSan checks. See user manual for available UBSan checks
  ...
  -fsanitize-trap-loop    Use infinite loops in trapping mode
  ...
  -fstrict-bool           Enable optimizations based on bool bit patterns never being anything other than 0 or 1
  ...
  -fsycl-device-image-split=<value>
                          Select the granularity at which SYCL device code is grouped into device images: kernel (one device image per kernel) | translation_unit (one device image per translation unit) | link_unit (one device image per linking unit). Default is 'translation_unit'.
  -fsycl-device-image-split
                          Group SYCL device code into device images: one per 'translation_unit'.
  ...
  -fwin-cfg-mechanism=<value>
                          Sets the mechanism to use for Control Flow Guard on Windows
  -fwinx64-eh-unwind=<value>
                          Set x64 Windows unwind info version
  -fwinx64-eh-unwindv2=<value>
                          (Legacy) Generate unwind v2 (epilog) information for x64 Windows
  ...
  -fzero-call-used-regs=<value>
                          Clear call-used registers upon function return (AArch64/RISC-V/x86 only)
  ...
  -lifetime-safety-lifetimebound-macro=<macro>
                          Use the given macro name when suggesting lifetimebound attributes
  -lifetime-safety-max-cfg-blocks=<value>
                          Skip LifetimeSafety analysis for functions with CFG block count exceeding this threshold. Specify 0 for no limit.
  ...
  -maix-use-ptrgl         Use ._ptrgl routine for indirect calls (AIX only)
  ...
  -marm64x<value>         Build as a hybrid ARM64X object/image
  ...
  -mexperimental-mtune-syntax
                          Enable experimental syntax for the '-mtune' flag (RISC-V only)
  ...
  -mfix-r5900             Enable R5900 short loop erratum fix
  ...
  -mhvx-qfloat=<value>    Enable Hexagon HVX QFloat instructions with mode: strict-ieee, ieee, lossy, legacy (v79+)
  ...
  -mno-aix-use-ptrgl      Emit indirect calls inline (AIX only) (default)
  ...
  -mno-experimental-mtune-syntax
                          Disable experimental syntax for the '-mtune' flag (RISC-V only)
  ...
  -mno-fix-r5900          Disable R5900 short loop erratum fix
  ...
  -mno-outline            Disable function outlining (AArch64,Arm,RISC-V,X86 only)
  ...
  -mno-sramecc            Disable SRAMECC (AMDGPU only)
  ...
  -mno-zos-ppa1-name      Do not emit the function name in PPA1 on z/OS
  ...
  -moutline               Enable function outlining (AArch64,Arm,RISC-V,X86 only)
  ...
  -mscs-reg=<value>       Register holding the shadow call stack pointer: one of the callee-saved registers r16-r27, default r18 (Hexagon only). The chosen register must also be reserved with -ffixed-<reg>.
  ...
  -msramecc               Enable SRAMECC (AMDGPU only)
  ...
  -mstack-protector-guard-record
                          Generate a __stack_protector_loc section entry for each load of the stack-protector guard address.
  -mstack-protector-guard-reg=<value>
                          Use the given reg for addressing the stack-protector guard
  -mstack-protector-guard-symbol=<value>
                          Use the given symbol for addressing the stack-protector guard
  -mstack-protector-guard-value-width=<value>
                          Use the given width for the value of the the stack-protector guard (AArch64-only)
  ...
  -mzilsd-strict-align    Force all Zilsd/Zclsd memory accesses to be 8-byte aligned (RISC-V only)
  -mzilsd-word-align      Allow Zilsd/Zclsd memory accesses to be 4-byte aligned (RISC-V only)
  ...
  -mzos-ppa1-name         Emit the function name in PPA1 on z/OS
  ...
  --no-xcselect           Disable xcselect SDK injection on macOS
  ...
  -nolibsycl              Do not link the SYCL runtime library
  ...
  --precompile-reduced-bmi
                          Only precompile the input as a reduced BMI
  ...
  --ssaf-compilation-unit-id=<id>
                          Stable identifier used as the CompilationUnit namespace name of every produced SSAF TU summary. Required when '--ssaf-tu-summary-file=' is set.
  --ssaf-extract-summaries=<summary-names>
                          Comma-separated list of summary names to extract
  --ssaf-include-local-entities
                          Include block-scope (function-local) declarations in extracted SSAF summaries. By default they are omitted.
  --ssaf-list-extractors  Display the list of available SSAF summary extractors
  --ssaf-list-formats     Display the list of available SSAF serialization formats
  --ssaf-tu-summary-file=<path>.<format>
                          The output file for the extracted summaries. The extension selects which file format to use.
...
dxc compatibility options.:
  ...
  --spirv-val-path=<value>
                          SPIRV validator installation path
