...
Start with `README.md` for layout, `docs/SETUP.md` for setup/config, `docs/USAGE.md` for flags and examples. See `docs/ARCHITECTURE.md` for concepts, design rationale, and the full call-flow diagram.
